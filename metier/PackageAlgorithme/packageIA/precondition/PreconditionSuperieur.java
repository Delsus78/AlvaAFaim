...
/**
 * Precondition supérieur ou égal d'une règle de l'IA qui hérite de Precondition
 * @author UNC
 */
public class PreconditionSuperieur extends Precondition{

    /**
     * Constructeur d'une condition inférieur ou égal
     * @param parametre paramètre devant être validé
     * @param val un entier, la valeur à comparer
     */
    public PreconditionSuperieur(Parametre parametre, Integer val) {
        super(parametre, val);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PreconditionSuperieur) {
            PreconditionSuperieur other = (PreconditionSuperieur) obj;
